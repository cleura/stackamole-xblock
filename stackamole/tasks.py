...
class LaunchStackTask(StackamoleTask):
    """
    ...
    name = "stackamole.tasks.launch_stack_task"
...
class SuspendStackTask(StackamoleTask):
    """
    Suspends a stack.

    """

    name = "stackamole.tasks.suspend_stack_task"
...
class DeleteStackTask(StackamoleTask):
    """
    Deletes a stack.

    """

    name = "stackamole.tasks.delete_stack_task"
...
class CheckStudentProgressTask(StackamoleTask):
    """
    Check student progress by running a set of scripts via SSH.

    """

    name = "stackamole.tasks.check_student_progress_task"
