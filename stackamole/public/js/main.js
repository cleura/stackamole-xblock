function StackamoleXBlock(runtime, element, configuration) {
    "use strict";
    ...
    if ('StackamoleI18N' in window) {
        gettext = function(string) {
            return window.StackamoleI18N.gettext(string);
        };
    ...
    var init = function() {
        ...
        if (configuration.hidden) {
            $('.xblock-student_view-stackamole').hide();
        ...
        terminal_client = StackamoleGuacamoleClient(configuration)
